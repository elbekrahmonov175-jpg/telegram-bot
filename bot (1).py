...
SYSTEM_PROMPT = """Ты вежливый и полезный ассистент. Отвечаешь вместо владельца бизнеса.
Общайся дружелюбно и профессионально.
Отвечай на том языке, на котором пишет пользователь.
Если не знаешь ответ — скажи что владелец скоро ответит лично."""
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # Обработка обычных сообщений и Business сообщений
...
def main():
    ...
    # Обработчик для Telegram Business сообщений
